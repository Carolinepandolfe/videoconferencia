...
class VideoRoomComponent extends Component {
    constructor(props) {
        ...
        this.userId = [
            ...
            {name: 'Maria', user_id: 9, sessionId:'ped'},
            {name: 'Carlos', user_id: 3, sessionId:'onco'},
            {name: 'Vanessa', user_id: 2, sessionId:'gine'},
        ];
        let session = false;
            for(let value in this.userId){
                if(value.name === userName && value.sessionId === sessionName){
                    session = true
                }
            }

          if (session === false){
            //   alert("Error você é um intruso aqui só videos proibidos!!")
          }
        this.state = {
